...
Source0  : https://files.pythonhosted.org/packages/8b/ac/ea19242153b5e8be412a726a70e82c7b5c1537c83f61b20995b2eda3dcd7/configparser-7.2.0.tar.gz
...
%prep
%setup -q -n configparser-7.2.0
cd %{_builddir}/configparser-7.2.0
pushd ..
cp -a configparser-7.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742454460
